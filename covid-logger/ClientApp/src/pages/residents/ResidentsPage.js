...
export class ResidentsPage extends React.Component {
    ...
    async fetchResidents() {
        ...
        let req = axios.get(`/api/reports/all-residents?${params.toString()}`);
        let res = await req;
    ...
    render() {
        return (
            <div>
                <h1>Residents</h1>
                <p>Viewing all residents ({this.state.residents ? this.state.residents.length : 0})</p>
